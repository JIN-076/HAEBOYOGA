...
public class SkipActivity_fitness_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_skip_fitness_2);

        retry = (Button) findViewById(R.id.b_retry);
        retry.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent2 = new Intent(getApplicationContext(),CamActivity_fitness_2.class);// 현재 동작 다시하기 버튼
